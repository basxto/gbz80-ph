...
custom-peeph.def: custom/incdec.def custom/redundancy.def custom/16bitarithmetic.def custom/ram.def custom/load.def custom/lddi.def custom/jump.def custom/pusharg.def
	cat $^ > $@
